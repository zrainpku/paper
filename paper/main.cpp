...
//    std::string test=hash_img();
    ...
    // class hash;
    Hash hash;
//    cv::Mat img=cv::imread(Websource+"picD.png",CV_LOAD_IMAGE_GRAYSCALE);
    cv::Mat img1=cv::imread(Websource+"picC.png",CV_LOAD_IMAGE_GRAYSCALE);
    
    cv::Mat img2=cv::imread(Websource+"temp/imgling44C.png",CV_LOAD_IMAGE_GRAYSCALE);
    cv::Mat img3=cv::imread(Websource+"temp/imgling44D.png",CV_LOAD_IMAGE_GRAYSCALE);
